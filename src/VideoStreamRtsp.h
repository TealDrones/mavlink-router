...
public:
    ...
    GstElement* getcrop();
    int setfsimage(GstElement* element);
    GstElement* getfsimage();
    int setfsvideo(GstElement* element);
    GstElement* getfsvideo();
    int setvimage(GstElement* element);
